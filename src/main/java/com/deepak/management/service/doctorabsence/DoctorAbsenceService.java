...
public interface DoctorAbsenceService {
    ...
    List<DoctorAbsenceInformation> getDoctorAbsenceInformationsByDateAndClinic(Pageable paging, Date date, Integer clinicId);

    List<DoctorAbsenceInformation> getDoctorAbsenceInformationsByDateAndDoctor(Pageable paging, Date date, String doctorId);

    Optional<DoctorAbsenceInformation> updateDoctorAbsenceInformationById(Long id, DoctorAbsenceInformation doctorAbsenceInformation) throws DoctorAbsenceNotFound;
