...
public interface DoctorService {
  ...
  DoctorInformation updateDoctor(@PathVariable Long doctorId, @RequestBody DoctorInformation doctorInformation)
  ...
  Optional<DoctorInformation> getDoctorByDoctorIdAndClinicId(String doctorId, Integer clinicId) throws DoctorNotFound;

  DoctorInformation updateDoctorByDoctorIdAndClinicId(String doctorId, Integer clinicId,
      DoctorInformation doctorInformation) throws ClinicNotFound, DoctorNotFound;

  void deleteDoctorByDoctorIdAndClinicId(String doctorId, Integer clinicId) throws DoctorNotFound;
}
