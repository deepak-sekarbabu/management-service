...
public class ClinicInformation {
  ...
  @Schema(
      description = "List of contact phone numbers for the clinic, each as an object with a phoneNumber field.",
      example = """
                [
                        {
  ...
  @Schema(
      ...
      example = "General Medicine, Cardiology, Pediatrics, Pharmacy, AC Waiting Lounge, Free WiFi, Wheelchair Access")
