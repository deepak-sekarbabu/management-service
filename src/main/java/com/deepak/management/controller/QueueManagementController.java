...
@Tag(
    ...
    description = "APIs for managing queue and patient status information")
public class QueueManagementController {
        ...
        @ApiResponse(
            ...
            content =
                @Content(
                    ...
                    array =
                        @ArraySchema(schema = @Schema(implementation = QueueManagementDTO.class)))),
        @ApiResponse(
            responseCode = "500",
  ...
  @ApiResponses(
      value = {
        @ApiResponse(responseCode = "200", description = "Patient marked as reached"),
        @ApiResponse(
            responseCode = "404",
  ...
  @ApiResponses(
      value = {
        @ApiResponse(responseCode = "200", description = "Patient marked as cancelled"),
        @ApiResponse(
            responseCode = "404",
            description = "Queue record not found",
            content =
  ...
  @ApiResponses(
      value = {
        @ApiResponse(responseCode = "200", description = "Patient marked as visited"),
        @ApiResponse(
            responseCode = "404",
            description = "Queue record not found",
            content =
  ...
  @ApiResponses(
      value = {
        @ApiResponse(responseCode = "200", description = "Patient marked as deleted"),
        @ApiResponse(
            responseCode = "404",
            description = "Queue record not found",
            content =
  ...
  @ApiResponses(
      value = {
        @ApiResponse(responseCode = "200", description = "Patient skipped"),
        @ApiResponse(
            responseCode = "404",
            description = "Queue record not found",
            content =
