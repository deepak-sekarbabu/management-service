...
@Tag(name = "Doctor Absence Management", description = "APIs to manage doctor absences like vacations, unavailability, etc.")
@Validated
public class DoctorAbsenceController {
  ...
  @Operation(
          ...
          description = "Creates a record of a doctor's absence with details such as date, reason, and doctor ID.",
  ...
  @ApiResponses(value = {
    @ApiResponse(
      ...
      content = @Content(
        mediaType = "application/json",
        array = @io.swagger.v3.oas.annotations.media.ArraySchema(schema = @Schema(implementation = DoctorAbsenceInformation.class))
      )
    ),
    @ApiResponse(
      responseCode = "400",
  ...
  @ApiResponses(value = {
    @ApiResponse(
      responseCode = "200",
      description = "Successfully retrieved doctor absences for the specified date and clinic",
      content = @Content(
        mediaType = "application/json",
        array = @io.swagger.v3.oas.annotations.media.ArraySchema(schema = @Schema(implementation = DoctorAbsenceInformation.class))
      )
  ...
  @ApiResponses(value = {
    @ApiResponse(
      responseCode = "200",
      description = "Successfully retrieved doctor absences for the specified date and doctor",
      content = @Content(
        mediaType = "application/json",
        array = @io.swagger.v3.oas.annotations.media.ArraySchema(schema = @Schema(implementation = DoctorAbsenceInformation.class))
      )
  ...
  @Operation(
    ...
    description = "Fetches detailed information about a specific doctor absence record using its unique identifier.",
    parameters = {
      @io.swagger.v3.oas.annotations.Parameter(
        name = "id",
  ...
  @Operation(
    ...
    description = "Updates the information of an existing doctor absence record using its unique identifier.",
    parameters = {
      @io.swagger.v3.oas.annotations.Parameter(
        name = "id",
        description = "Unique identifier of the doctor absence record",
  ...
  @ApiResponses(value = {
    @ApiResponse(
      responseCode = "204",
      description = "Doctor absence successfully deleted"
    ),
    @ApiResponse(
      responseCode = "404",
      description = "Doctor absence not found with the given ID",
  ...
  @Operation(
    ...
    description = "Retrieves a paginated list of doctor absences after a specified date for a given clinic.",
    parameters = {
      @io.swagger.v3.oas.annotations.Parameter(
        name = "page",
        description = "Page number (0-based) for pagination",
  ...
  @ApiResponses(value = {
    @ApiResponse(
      responseCode = "200",
      description = "Successfully retrieved doctor absences after the specified date for the clinic",
      content = @Content(
        mediaType = "application/json",
        array = @io.swagger.v3.oas.annotations.media.ArraySchema(schema = @Schema(implementation = DoctorAbsenceInformation.class))
      )
  ...
  @Operation(
    ...
    description = "Retrieves a paginated list of doctor absences between two dates for a given clinic.",
    parameters = {
      @io.swagger.v3.oas.annotations.Parameter(
        name = "page",
        description = "Page number (0-based) for pagination",
  ...
  @ApiResponses(value = {
    @ApiResponse(
      responseCode = "200",
      description = "Successfully retrieved doctor absences for the specified date range and clinic",
      content = @Content(
        mediaType = "application/json",
        array = @io.swagger.v3.oas.annotations.media.ArraySchema(schema = @Schema(implementation = DoctorAbsenceInformation.class))
      )
  ...
  @Operation(
    ...
    description = "Retrieves a paginated list of doctor absences between two dates for a given doctor.",
    parameters = {
      @io.swagger.v3.oas.annotations.Parameter(
        name = "page",
        description = "Page number (0-based) for pagination",
  ...
  @ApiResponses(value = {
    @ApiResponse(
      responseCode = "200",
      description = "Successfully retrieved doctor absences for the specified date range and doctor",
      content = @Content(
        mediaType = "application/json",
        array = @io.swagger.v3.oas.annotations.media.ArraySchema(schema = @Schema(implementation = DoctorAbsenceInformation.class))
      )
